...
const passwordSchema: ParamSchema = {
  ...
  isString: { errorMessage: USERS_MESSAGES.PASSWORD_IS_A_STRING },
  isLength: { options: { min: 6, max: 50 }, errorMessage: USERS_MESSAGES.PASSWORD_MUST_BE_FROM_6_TO_50 },
  isStrongPassword: {
...
const confirmPasswordSchema: ParamSchema = {
  ...
  isString: { errorMessage: USERS_MESSAGES.CONFIRM_PASSWORD_IS_A_STRING },
  isLength: { options: { min: 6, max: 50 }, errorMessage: USERS_MESSAGES.CONFIRM_PASSWORD_MUST_BE_FROM_6_TO_50 },
  isStrongPassword: {
    options: { minLength: 6, minLowercase: 1, minUppercase: 1, minNumbers: 1, minSymbols: 1 },
...
const nameSchema: ParamSchema = {
  ...
  isLength: { options: { min: 1, max: 100 }, errorMessage: USERS_MESSAGES.NAME_MUST_BE_A_STRING },
  trim: true
}
...
export const imageURLSchema: ParamSchema = {
  optional: true,
  trim: true,
  ...
  custom: {
    options: async (value: string, { req }) => {
      ...
      if (followed_user === null) {
        throw new ErrorWithStatus({
          message: USERS_MESSAGES.FOLLOWED_USER_ID_NOT_FOUND,
          status: HTTP_STATUS.NOT_FOUND
        })
      }
    }
  ...
  checkSchema(
    {
      ...
      email: {
        ...
        custom: {
          ...
          errorMessage: USERS_MESSAGES.EMAIL_ALREADY_EXISTED
        }
      },
      password: {
        notEmpty: { errorMessage: USERS_MESSAGES.PASSWORD_IS_REQUIRED },
        ...
        options: async (value: string, { req }) => {
          ...
          try {
            ...
            if (refresh_token === null) {
              throw new ErrorWithStatus({
                message: USERS_MESSAGES.REFRESH_TOKEN_USED_OR_NOT_EXSITED,
                status: HTTP_STATUS.UNAUTHORIZED
              })
            }

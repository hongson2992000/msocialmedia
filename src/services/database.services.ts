...
const uri = `mongodb+srv://${envConfig.dbUsername}:${envConfig.dbPassword}@twitter-dev-api.1luuyop.mongodb.net/?retryWrites=true&w=majority&appName=Twitter-Dev-API`

...
const uri = `mongodb+srv://${process.env.DB_USERNAME}:${process.env.DB_PASSWORD}@twitter-dev-api.1luuyop.mongodb.net/?retryWrites=true&w=majority&appName=Twitter-Dev-API`
